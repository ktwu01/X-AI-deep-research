...
# Core AI research query
TWITTER_QUERY = '''("AI" OR "LLM") AND ("research" OR "researching") AND (
"product" OR "feature" OR "tool" OR "model" OR
"launch" OR "launched" OR "launching" OR
"release" OR "released" OR "releasing" OR
"announce" OR "announced" OR "announcing" OR
"introduce" OR "introduced" OR "introducing" OR
"unveil" OR "unveiled" OR "unveiling"
) lang:en -is:retweet'''
